...
class DatabaseSeeder extends Seeder
{
    public function run()
    {
        ...
        // Professeurs
        $u1 = User::create(['name' => 'Alami Rachid',   'email' => 'alami@univ.ma',    'password' => Hash::make('prof123'), 'role' => 'prof', 'is_admin' => 0]);
        $u2 = User::create(['name' => 'Bennani Souad',  'email' => 'bennani@univ.ma',   'password' => Hash::make('prof123'), 'role' => 'prof', 'is_admin' => 0]);
        $u3 = User::create(['name' => 'Fassi Mohamed',  'email' => 'fassi@univ.ma',     'password' => Hash::make('prof123'), 'role' => 'prof', 'is_admin' => 0]);
        $u4 = User::create(['name' => 'Tazi Hind',      'email' => 'tazi@univ.ma',      'password' => Hash::make('prof123'), 'role' => 'prof', 'is_admin' => 0]);
        $u5 = User::create(['name' => 'Cherkaoui Omar', 'email' => 'cherkaoui@univ.ma', 'password' => Hash::make('prof123'), 'role' => 'prof', 'is_admin' => 0]);
        $u6 = User::create(['name' => 'Bennani Younes', 'email' => 'younes@univ.ma',    'password' => Hash::make('prof123'), 'role' => 'prof', 'is_admin' => 0]);
        ...
        // Étudiants
        $eu1 = User::create(['name' => 'Ali Benali',     'email' => 'etudiant@univ.ma', 'password' => Hash::make('etudiant123'), 'role' => 'etudiant', 'is_admin' => 0]);
        $eu2 = User::create(['name' => 'Sara Idrissi',   'email' => 'sara@univ.ma',     'password' => Hash::make('etudiant123'), 'role' => 'etudiant', 'is_admin' => 0]);
        $eu3 = User::create(['name' => 'Youssef Amrani', 'email' => 'youssef@univ.ma',  'password' => Hash::make('etudiant123'), 'role' => 'etudiant', 'is_admin' => 0]);
