            ...
            <div class="step-footer">
                ...
                >
                    ...
                    <span v-else>
                        ...
                        Enregistrer {{ absentsSelectionnes.length }} absence(s)
                    </span>
                </button>
            </div>
        </div>
...
export default {
    ...
    methods: {
        ...
        async chargerSeances() {
            // Recharger les séances quand on change de module
        ...
        async creerSeance() {
            ...
            try {
                ...
                // Ajouter la séance créée et la sélectionner
        ...
        toggleAbsent(id) {
            ...
            if (idx === -1) {
                this.absentsSelectionnes.push(id);
            } else {
                this.absentsSelectionnes.splice(idx, 1);
            }
        },
        toutSelectionner() {
            this.absentsSelectionnes = this.etudiants.map((e) => e.id);
        },
        toutDeselectionner() {
        ...
        async enregistrerAbsences() {
            ...
            try {
                this.saving = true;
                // Enregistrer une absence pour chaque étudiant sélectionné
                await Promise.all(
